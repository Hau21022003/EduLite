...
export default function TestimonialCard() {
  ...
  return (
    <div className="h-full w-full relative">
      <div className="w-full h-full rounded-3xl overflow-hidden bg-gradient-to-br from-blue-100 via-blue-300 to-blue-500 p-4 flex flex-col justify-end">
        {/* Quote box */}
        <div className="relative bg-white/30 backdrop-blur-md rounded-2xl p-3 text-white mt-auto">
          ...
          <div className="absolute bottom-0 right-0 w-26 h-14 bg-[#4a90f8] rounded-tl-[20px] z-10" />
          <div className="absolute bottom-14 right-0 w-3 h-3 bg-[#4a90f8] [mask-image:radial-gradient(circle_at_top_left,transparent_70%,black_71%)]"></div>
          <div className="absolute bottom-0 right-26 w-3 h-3 bg-[#4a90f8] [mask-image:radial-gradient(circle_at_top_left,transparent_70%,black_71%)]"></div>
        </div>
      </div>
